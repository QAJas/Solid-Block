...
//    driver.findElement(By.cssSelector(constants.NewHomeLoc.LEARN)).click();
////    driver.getCurrentUrl().equals(NewHomeLoc.);
//    }
//    @Test (description = "home links ")
//    public void Email (){
//        driver.get(HomePageLocators.HOME_URL);
//        driver.findElement(By.cssSelector(HomePageLocators.LOGIN)).sendKeys("test@gmail.com");
...
//    public void Tok(){
//        driver.get(HomePageLocators.HOME_URL);
//        driver.findElement(By.cssSelector(constants.NewHomeLoc.TOK_LINK)).click();
