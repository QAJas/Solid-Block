...
public class BuyDetox extends BaseTest {
    @Test
    public void BuyWithCrypto() throws InterruptedException {
        ...
        WaitFor.WaitFori(driver, BuyLoc.DETOX).isDisplayed();
        actions.moveToElement(driver.findElement(By.cssSelector(BuyLoc.DETOX)));
        WebElement elementL = driver.findElement(By.cssSelector(BuyLoc.DETOX));
